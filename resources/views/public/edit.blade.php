...
@section('content')
    ...
    <form action="{{ route('addMessage') }}" method="post" enctype="multipart/form-data" id="signupId">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <textarea name="message" id="messageId" rows="5" cols="40" class="form-control">{!!  $message->message !!}</textarea>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="button" class="btn btn-default " id="addBtn">Update</button>
